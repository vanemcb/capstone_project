...
const Levels = () => {
  ...
  return (
    ...
    <ul className="list-group text-center" style={{width: '100%'}}>
      <li className="list-group-item active" style={{ background: "#DEE0E6", color: "black" }}>{dict ? dict.company_name : "No data"}</li>
